...
export class CreateLedgerTables1765000000000 implements MigrationInterface {
    name = 'CreateLedgerTables1765000000000';
    ...
    `);
        // Match TypeORM naming for unique index
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_e9a270270815811eeca8b2ed5c" ON "ledger_account" ("channelId","code");`);
    ...
    `);
        // Unique constraint with expected name
    ...
    `);
        // Index and FKs with expected names
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f9cd7e4e7ad494c04ac5fc2524" ON "ledger_journal_line" ("entryId");`);
        await queryRunner.query(`DO $$
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_f9cd7e4e7ad494c04ac5fc25244') THEN
        ALTER TABLE "ledger_journal_line"
        ADD CONSTRAINT "FK_f9cd7e4e7ad494c04ac5fc25244"
        FOREIGN KEY ("entryId") REFERENCES "ledger_journal_entry"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
      END IF;
    END $$;`);
        await queryRunner.query(`DO $$
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_185fa35d92d3dc5aebc6c6e284c') THEN
        ALTER TABLE "ledger_journal_line"
        ADD CONSTRAINT "FK_185fa35d92d3dc5aebc6c6e284c"
        FOREIGN KEY ("accountId") REFERENCES "ledger_account"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;
      END IF;
    END $$;`);
    ...
    `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_2bfa5e2744f391a3887f3d82c4" ON "cashier_session" ("channelId","openedAt");`);
    ...
    `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_4baeb5137224fe3eef32c75b66" ON "reconciliation" ("channelId","rangeStart","rangeEnd");`);
    ...
    `);
        // Add unique constraint with expected name
        await queryRunner.query(`DO $$
    BEGIN
      IF NOT EXISTS (
    ...
    END $$;`);
        ...
        // Seed minimal accounts for channel 1 (safe default; real setup should insert per channel on bootstrap)
        await queryRunner.query(`
    ...
    `);
        ...
        // Drop legacy-named indexes if present to silence schema diff
