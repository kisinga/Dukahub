...
export class MetricsService {
    ...
    private initializeMetrics(): void {
        // Business metrics
        this.createCounter('orders_created_total', 'Total number of orders created', ['channel_id', 'payment_method']);
        this.createCounter('payments_processed_total', 'Total number of payments processed', ['channel_id', 'method']);
        ...
        // Performance metrics
        this.createHistogram('request_duration_seconds', 'Request duration in seconds', ['route', 'method', 'status']);
