...
export class RegistrationService {
     ...
     * 
     * NOTE: Registration is passwordless - the generated password is never used.
     * Authentication is done via OTP (One-Time Password) sent to the phone number.
     * 
     * NOTE: We use repository directly to bypass permission checks since we're creating
     ...
     * 
     * This password is generated internally to satisfy Vendure's User entity requirements.
     * It is never used for authentication - the system uses passwordless OTP authentication.
     */
