...
import { Allow, Args, Asset, AssetService, ChannelService, Ctx, Permission, RequestContext, Transaction } from '@vendure/core';
 ...
 * ML Model File Types
 */
export type MlModelFileType = 'model' | 'metadata' | 'labels';

/**
 * Custom fields for Channel entity to store ML model file assets
 */
const ML_MODEL_CUSTOM_FIELDS = {
    Channel: [
        {
            name: 'mlModelJson',
            type: 'relation',
            ...
            scalarFields: false,
            nullable: true,
            label: [{ languageCode: 'en', value: 'ML Model JSON File' }],
            description: [{ languageCode: 'en', value: 'TensorFlow.js model.json file for product recognition' }],
        },
        {
            name: 'mlModelBin',
            type: 'relation',
            ...
            scalarFields: false,
            nullable: true,
            label: [{ languageCode: 'en', value: 'ML Model Binary Files' }],
            description: [{ languageCode: 'en', value: 'TensorFlow.js model binary files (weights.bin, etc.)' }],
        },
        {
            name: 'mlMetadata',
            type: 'relation',
            ...
            scalarFields: false,
            nullable: true,
            label: [{ languageCode: 'en', value: 'ML Model Metadata' }],
            description: [{ languageCode: 'en', value: 'Model metadata JSON file with training information' }],
        },
        {
            name: 'mlModelVersion',
            type: 'string',
            nullable: true,
            label: [{ languageCode: 'en', value: 'ML Model Version' }],
            description: [{ languageCode: 'en', value: 'Version identifier for the ML model' }],
        },
        {
            name: 'mlModelStatus',
            type: 'string',
            nullable: true,
            label: [{ languageCode: 'en', value: 'ML Model Status' }],
            description: [{ languageCode: 'en', value: 'Status of the ML model (active, training, inactive)' }],
        },
    ],
};
...
// Export the resolver for use in other parts of the application
export { MlModelResolver } from './ml-model-resolver';
