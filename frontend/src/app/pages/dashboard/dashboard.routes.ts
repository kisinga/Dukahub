...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'open-close-financial', loadComponent: () => import('./open-close/open-close-financial/open-close-financial.page').then((m) => m.OpenCloseFinancialPage) },
            { path: 'open-close-stock', loadComponent: () => import('./open-close/open-close-stock/open-close-stock.page').then((m) => m.OpenCloseStockPage) },
