...
describe('DashboardLayoutComponent', () => {
    ...
    beforeEach(async () => {
        ...
        const stockLocationSpy = jasmine.createSpyObj('StockLocationService', ['clearLocations', 'fetchStockLocationsWithCashier']);
        const appInitSpy = jasmine.createSpyObj('AppInitService', ['initializeDashboard', 'clearCache']);
