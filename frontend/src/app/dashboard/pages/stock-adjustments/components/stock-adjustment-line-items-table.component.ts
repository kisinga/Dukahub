                  ...
                  <tr>
                    <td>
                      ...
                      <div class="text-xs opacity-60">
                        SKU: {{ line.variant?.sku || line.variantId }}
                      </div>
                    </td>
                    <td class="text-right">
                    ...
                    <td class="text-right">
                      <input
                        ...
                        (change)="
                          onNewStockUpdate($index, parseFloat($any($event.target).value) || 0)
                        "
                      />
                    </td>
                    <td class="text-right">
              ...
              @for (line of lineItems(); track $index) {
                <div class="p-4 space-y-3">
                  ...
                  <div class="form-control">
                    ...
                    @for (location of stockLocations(); track location.id) {
                      @if (location.id === line.stockLocationId) {
                        <div class="input input-bordered w-full bg-base-200 text-base-content">
                          {{ location.name }}
                        </div>
                      }
                    }
