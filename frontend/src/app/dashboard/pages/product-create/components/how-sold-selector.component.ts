    ...
    <div class="card bg-base-100 shadow">
      <div class="card-body p-3 space-y-3">
        ...
        <p class="text-xs opacity-60">
          Choose the option that best matches how customers buy this item. You can fine-tune details
          in the next step.
        </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          >
            <div>
              ...
              <div class="text-[11px] opacity-70">One SKU only (e.g. one size or pack).</div>
            </div>
          </button>
          ...
          >
            <div>
              ...
              <div class="text-[11px] opacity-70">Sold by weight with fractional quantities.</div>
            </div>
          </button>
          ...
          >
            <div>
              ...
              <div class="text-[11px] opacity-70">Sold by volume with fractional quantities.</div>
            </div>
          </button>
        </div>
      </div>
