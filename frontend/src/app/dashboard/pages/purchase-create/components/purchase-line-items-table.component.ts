                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        min="0.01"
                                        [value]="line.quantity"
                                        (change)="onLineItemUpdate($index, 'quantity', parseFloat($any($event.target).value))"
                                    />
                                </td>
                                <td>
                                    <input
                                        ...
                                        min="0"
                                        [value]="line.unitCost"
                                        (change)="onLineItemUpdate($index, 'unitCost', parseFloat($any($event.target).value))"
                                    />
                                </td>
                                ...
                                <td>
                                    <select
                                        ...
                                        (change)="onLineItemUpdate($index, 'stockLocationId', $any($event.target).value)"
                                    >
