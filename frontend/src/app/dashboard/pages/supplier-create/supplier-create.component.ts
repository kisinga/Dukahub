        ...
        <div class="min-h-screen bg-base-100">
            ...
            <div class="p-4">
                ...
                @if (step() === 1) {
                    ...
                    <form [formGroup]="basicForm" (ngSubmit)="onBasicSubmit()" class="space-y-4 max-w-md mx-auto">
                        <!-- Business Name -->
                ...
                @if (step() === 2) {
                    ...
                    <form [formGroup]="supplierForm" (ngSubmit)="onSupplierSubmit()" class="space-y-4 max-w-md mx-auto">
                        <!-- Supplier Type -->
                        <div class="input-wrapper">
                            <label class="text-sm font-semibold label-text mb-1 block">
                                🏭 Supplier Type
...
export class SupplierCreateComponent {
    ...
    async onSupplierSubmit(): Promise<void> {
        ...
        try {
            ...
            supplierInput.emailAddress = this.basicForm.value.emailAddress || this.generatePlaceholderEmail(this.basicForm.value.businessName);
