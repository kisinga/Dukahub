      ...
      <div class="modal-box max-w-md">
        ...
        <div class="space-y-3 mb-6">
          <div class="alert alert-warning">
            ...
            <div class="text-sm">
              <strong>Expensive Operation:</strong> Changing product photos will trigger AI model
          ...
          <div class="bg-base-200 p-3 rounded text-sm">
            <p>
              <strong>💡 Tip:</strong> Only edit photos if the current ones are incorrect or
              missing. Consider if the change is really necessary.
            </p>
          </div>
        </div>
        ...
        <div class="modal-action">
          <button type="button" (click)="onCancel()" class="btn btn-ghost">Cancel</button>
          <button type="button" (click)="onConfirm()" class="btn btn-warning">
            <span
