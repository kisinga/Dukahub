      ...
      <div class="card-body space-y-6">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-base-content/60">Current machine learning model configuration and training status</p>
          </div>
        </div>
        ...
        <div class="space-y-2">
          ...
          <progress class="progress progress-primary w-full" [value]="configurationProgress()" max="100"></progress>
        </div>
