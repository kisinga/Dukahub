...
export type GetActiveChannelQuery = { __typename?: 'Query', activeChannel: { __typename?: 'Channel', id: string, code: string, token: string, customFields?: { __typename?: 'ChannelCustomFields', mlModelJsonId?: string | null, mlModelBinId?: string | null, mlMetadataId?: string | null, companyLogoId?: string | null } | null } };
...
export type GetStockLocationsWithCashierQuery = { __typename?: 'Query', stockLocations: { __typename?: 'StockLocationList', items: Array<{ __typename?: 'StockLocation', id: string, name: string, description: string, customFields?: { __typename?: 'StockLocationCustomFields', cashierFlowEnabled?: boolean | null, cashierOpen?: boolean | null } | null }> } };
...
export type CreateProductMutation = { __typename?: 'Mutation', createProduct: { __typename?: 'Product', id: string, name: string, slug: string, description: string, enabled: boolean, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, sku: string, price: number, priceWithTax: number, stockOnHand: number }> } };
...
export type GetProductDetailQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, slug: string, description: string, enabled: boolean, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, sku: string, price: number, priceWithTax: number, stockOnHand: number, stockLevels: Array<{ __typename?: 'StockLevel', id: string, stockOnHand: number, stockLocation: { __typename?: 'StockLocation', id: string, name: string } }> }> } | null };
...
export type GetProductOptionGroupsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductOptionGroupsQuery = { __typename?: 'Query', productOptionGroups: Array<{ __typename?: 'ProductOptionGroup', id: string, code: string, name: string, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string }> }> };
...
export type SearchByBarcodeQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', items: Array<{ __typename?: 'SearchResult', productId: string, productName: string, productVariantId: string, productVariantName: string, sku: string, price:
        | { __typename?: 'PriceRange' }
