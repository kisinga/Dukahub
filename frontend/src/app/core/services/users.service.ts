...
import { GET_ADMINISTRATOR_BY_ID } from '../graphql/operations.graphql';
...
export class UsersService {
    ...
    async fetchAdministratorById(id: string): Promise<UserDetails | null> {
        ...
        try {
            ...
            const result = await client.query<GetAdministratorByIdQuery, GetAdministratorByIdQueryVariables>({
