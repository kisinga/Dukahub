...
export class SubscriptionService {
    ...
    async getSubscriptionTiers(): Promise<SubscriptionTier[]> {
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Failed to fetch subscription tiers';
    ...
    async initiatePurchase(
        ...
        phoneNumber: string,
        email: string
    ): Promise<{ success: boolean; reference?: string; authorizationUrl?: string; message?: string }> {
        try {
