      ...
      try {
        ...
        if (this.userType === 'admin') {
          ...
          if (!company || !company.id) {
            console.warn('User logged in, but company info missing or invalid.', authRecord.expand);
        ...
        setTimeout(() => {
          if (redirectUrl) {
            ...
            this.message = 'Login succeeded but redirect failed. Please contact support.';
